...
const projects = [
  ...
  { id:"15", code:"BF", name:"Blind Flip", strap:"£200. Blind boxes. £1,000 profit.", description:"A mobile-first mystery-box reselling game where every purchase is blind, inventory space matters, and the run ends if realised P/L falls to -£100.", url:"https://blindflip.onrender.com/", type:"GAME / RESELLING", color:"#d8ff3e", ink:"#11110f" },
];
